;(function () {
    ...
    const settings = {
        'id': 'bert-heatmap-figure',
        'width': 900,
        'showMeta': true,
        'facetTitles': ['BERT', 'Distil BERT'],
        'rotateFacetTitles': true,
        'interactive': true
    };

    const instance = new TextualHeatmap(settings);

    fetch('./slides/tools/bert-heatmap-data.json')
